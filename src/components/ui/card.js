...
function Card({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card", className: cn("w-full bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border py-6 shadow-sm", className), ...props }));
}
...
function CardAction({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-action", className: cn("row-span-2 row-start-1 self-start justify-self-end", className), ...props }));
}
function CardContent({ className, ...props }) {
    return (_jsx("div", { "data-slot": "card-content", className: cn("px-6 py-4", className), ...props }));
}
